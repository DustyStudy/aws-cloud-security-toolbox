...
```
RemediationLambdaMapping = {"Port 22/3389 open to 0.0.0.0/0": "arn:aws:lambda:us-east-1:123456789012:function:your-wiz-adapter-...-remediate"}
RemediationLambdaArns    = arn:aws:lambda:us-east-1:123456789012:function:your-wiz-adapter-...-remediate
```
